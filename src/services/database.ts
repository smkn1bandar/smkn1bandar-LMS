...
export const INITIAL_USERS: User[] = [
  ...
  },
  {
    ...
    nama: 'Ahmad Syahri Nasution',
    nip: '19870415 201101 1 005',
    role: 'GURU',
  ...
  },
  {
    ...
    nama: 'Juliyarni Ndruru, S.Ag',
    nip: '19820514 200901 2 008',
    role: 'GURU',
    mata_pelajaran: 'Pendidikan Agama & Budi Pekerti',
    sekolah: 'SMK Negeri 1 Bandar',
  ...
  },
  {
    ...
    nama: 'Berliana Simbolon, S.Pd',
    nip: '19890311 201402 2 006',
    role: 'GURU',
  ...
  },
  {
    ...
    username: 'Winari',
    password: 'guru123',
    email: 'winari@guru.smk.belajar.id',
    nama: 'Winari Pridiyanti, S.Pd',
    nip: '19910423 201603 2 011',
    role: 'GURU',
  ...
  },
  {
    ...
    username: 'Harry',
    password: 'guru123',
    email: 'harry.prayogi@guru.smk.belajar.id',
    nama: 'Harry Prayogi Sihotang, S.Or',
    nip: '19900817 201504 1 003',
    role: 'GURU',
    mata_pelajaran: 'Pendidikan Jasmani & Kesehatan',
    sekolah: 'SMK Negeri 1 Bandar',
  ...
  },
  {
    ...
    username: 'Hijri',
    password: 'guru123',
    email: 'hijriyani@guru.smk.belajar.id',
    nama: 'Hijriyani Damanik, S.Akun',
    nip: '19930612 201902 2 014',
    role: 'GURU',
    mata_pelajaran: 'Akuntansi & Keuangan',
    sekolah: 'SMK Negeri 1 Bandar',
    foto: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=200&auto=format&fit=crop&q=80',
    status: 'AKTIF',
    tanggal_daftar: '2025-08-05',
    last_login: '2026-08-12 10:20',
  },
  {
    id_user: 'USR-007',
    username: 'Ria',
    password: 'guru123',
    email: 'ria.lestari@guru.smk.belajar.id',
    nama: 'Ria Lestari Situmorang, S.Pd',
    nip: '19920108 201801 2 007',
    role: 'GURU',
    ...
    status: 'AKTIF',
    tanggal_daftar: '2025-08-05',
    last_login: '2026-08-11 15:40',
  },
  {
    id_user: 'USR-008',
    username: 'Enni',
    password: 'guru123',
    email: 'enni.susila@guru.smk.belajar.id',
    nama: 'Enni Susila, S.Pd',
    nip: '19881125 201203 2 009',
    role: 'GURU',
    mata_pelajaran: 'IPAS Terapan',
    sekolah: 'SMK Negeri 1 Bandar',
    foto: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=200&auto=format&fit=crop&q=80',
    status: 'AKTIF',
    tanggal_daftar: '2025-08-06',
    last_login: '2026-08-10 08:30',
  },
  {
    id_user: 'USR-009',
    username: 'Santi',
    password: 'guru123',
    email: 'santi.sigiro@guru.smk.belajar.id',
    nama: 'Santiriana K Sigiro, S.Pd',
    ...
    status: 'AKTIF',
    tanggal_daftar: '2025-08-06',
    last_login: '2026-08-09 14:15',
  },
  {
    id_user: 'USR-010',
    username: 'Saramika',
    password: 'guru123',
    email: 'saramika@guru.smk.belajar.id',
    nama: 'Saramika, M.Pd',
    nip: '19840919 200802 2 005',
    role: 'GURU',
    ...
    last_login: '2026-08-08 11:00',
  },
  {
    id_user: 'USR-011',
    username: 'Dewani',
    password: 'guru123',
    email: 'dewani.novrida@guru.smk.belajar.id',
    nama: 'Dewani Novrida Nainggolan, S.Pd',
    nip: '19910530 201601 2 010',
    role: 'GURU',
    ...
    status: 'AKTIF',
    tanggal_daftar: '2025-08-07',
    last_login: '2026-08-07 13:45',
  },
  {
    id_user: 'USR-012',
    username: 'Togap',
    password: 'guru123',
    email: 'togap.pandiangan@guru.smk.belajar.id',
    nama: 'Togap Janris Pandiangan, S.Kom',
    nip: '19880716 201403 1 006',
    role: 'GURU',
    ...
    last_login: '2026-08-06 09:20',
  },
  {
    id_user: 'USR-013',
    username: 'Yolanda',
    password: 'guru123',
    email: 'yolanda.aruan@guru.smk.belajar.id',
    nama: 'Yolanda Aruan, S.Pd',
    nip: '19940321 202001 2 015',
    role: 'GURU',
    ...
    status: 'AKTIF',
    tanggal_daftar: '2025-08-08',
    last_login: '2026-08-05 16:30',
  },
  {
    id_user: 'USR-014',
    username: 'Dumaria',
    password: 'guru123',
    email: 'dumaria.gultom@guru.smk.belajar.id',
    nama: 'Therteen Dumaria Gultom, S.E',
    nip: '19861204 201001 2 009',
    role: 'GURU',
    ...
    last_login: '2026-08-04 10:15',
  },
  {
    id_user: 'USR-015',
    username: 'Amir',
    password: 'guru123',
    email: 'amir.purba@guru.smk.belajar.id',
    nama: 'Muhammad Amir Hamzah Purba',
    nip: '19890628 201502 1 008',
    role: 'GURU',
    ...
    status: 'AKTIF',
    tanggal_daftar: '2025-08-09',
    last_login: '2026-08-03 14:00',
  },
  {
    id_user: 'USR-016',
    username: 'Hotbinus',
    password: 'guru123',
    email: 'hotbinus.silaen@guru.smk.belajar.id',
    nama: 'Hotbinus Silaen, S.Pd',
    nip: '19870115 201103 1 005',
    role: 'GURU',
    mata_pelajaran: 'Fisika Peminatan',
    sekolah: 'SMK Negeri 1 Bandar',
    foto: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=200&auto=format&fit=crop&q=80',
    status: 'AKTIF',
    tanggal_daftar: '2025-08-10',
    last_login: '2026-08-02 11:30',
  },
  {
    id_user: 'USR-017',
    username: 'Mangapul',
    password: 'guru123',
    email: 'mangapul.pakpahan@guru.smk.belajar.id',
    nama: 'Sahat Mangapul Parningotan Pakpahan,S.T',
    nip: '19850409 201002 1 007',
    role: 'GURU',
    mata_pelajaran: 'Teknik Tenaga Listrik',
    sekolah: 'SMK Negeri 1 Bandar',
    foto: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=200&auto=format&fit=crop&q=80',
    status: 'AKTIF',
    tanggal_daftar: '2025-08-10',
    last_login: '2026-08-01 08:45',
  },
  {
    id_user: 'USR-018',
    username: 'Rizka',
    password: 'guru123',
    email: 'rizka.iranda@guru.smk.belajar.id',
    nama: 'Rizka Putri Iranda, M.Pd',
    nip: '19920819 201701 2 012',
    role: 'GURU',
    mata_pelajaran: 'Kimia Industri',
    sekolah: 'SMK Negeri 1 Bandar',
    foto: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=200&auto=format&fit=crop&q=80',
    status: 'AKTIF',
    tanggal_daftar: '2025-08-11',
    last_login: '2026-07-31 15:20',
  },
  {
    id_user: 'USR-019',
    username: 'Ester',
    password: 'guru123',
    email: 'ester.manurung@guru.smk.belajar.id',
    nama: 'Ester Manurung, S.Si',
    nip: '19910303 201602 2 009',
    role: 'GURU',
    mata_pelajaran: 'Biologi Farmasi',
    sekolah: 'SMK Negeri 1 Bandar',
    foto: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=200&auto=format&fit=crop&q=80',
    status: 'AKTIF',
    tanggal_daftar: '2025-08-11',
    last_login: '2026-07-30 09:10',
  },
  {
    id_user: 'USR-020',
    username: 'Wahidah',
    password: 'guru123',
    email: 'wahidah@guru.smk.belajar.id',
    nama: 'Wahidah, S.Pd',
    nip: '19891212 201401 2 007',
    role: 'GURU',
    mata_pelajaran: 'Bahasa Indonesia Kejuruan',
    sekolah: 'SMK Negeri 1 Bandar',
    foto: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=200&auto=format&fit=crop&q=80',
    status: 'AKTIF',
    tanggal_daftar: '2025-08-12',
    last_login: '2026-07-29 13:50',
  },
  {
    id_user: 'USR-021',
    username: 'budi.siswa',
    ...
    nip: 'NISN: 0078129384',
    role: 'SISWA',
    mata_pelajaran: 'Siswa Kelas XI RPL 1',
    sekolah: 'SMK Negeri 1 Bandar',
...
class DatabaseService {
  ...
  public initDatabase(forceReset = false): void {
    ...
    const shouldReset = forceReset || !existingSettings || existingSettings.includes('SMK Negeri 1 Digital Edukasi') || !existingUsers || !existingUsers.includes('"password"') || !existingUsers.includes('"Ahmad"');
  ...
  public authenticateUser(usernameOrEmail: string, passwordInput: string): { success: boolean; user?: User; message: string } {
    ...
    // Auto-seed if empty or missing new teacher accounts
    if (users.length === 0 || !users.some(u => u.username?.toLowerCase() === 'ahmad')) {
      localStorage.setItem(this.usersKey, JSON.stringify(INITIAL_USERS));
      users = INITIAL_USERS;
    }
    ...
    // Match by email, username, or first word of name
    const user = users.find(u => 
      (u.email && u.email.toLowerCase() === cleanInput) || 
      (u.username && u.username.toLowerCase() === cleanInput) ||
      (u.nama && u.nama.toLowerCase() === cleanInput) ||
      (u.nama && u.nama.toLowerCase().startsWith(cleanInput + ' '))
    );
    ...
    const validPassword = user.password || (user.role === 'ADMIN' ? 'admin' : user.role === 'GURU' ? 'guru123' : 'siswa123');
    const isMatch = 
